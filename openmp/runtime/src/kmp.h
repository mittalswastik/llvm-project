...
#define kmp_priority(gtid) kmp_schedarg[gtid]
...
extern int __kmp_check_edf(kmp_int32 priority);
...
static const int kmp_schedarg[10] = {30, 60, 50, 40, 50, 50, 50, 50, 50, 50};
...
extern void kmp_dep_in(kmp_task_t *task);
extern void kmp_dep_out(kmp_task_t *task);
...
static const int kmp_prio[7] = {1, 1, 1, 1, 1, 1, 1};
KMP_EXPORT int KMPC_CONVENTION
kmpc_get_affinity_mask_proc(int, kmp_affinity_mask_t *);
static const int kmp_controls[7] = {400, 1000, 250, 600, 800, 900, 1000};
...
#define kmp_period(gtid) kmp_controls[gtid]
#define kmp_rt_priority(gtid) kmp_prio[gtid]
#define kmp_rt_prio(gtid) rt_calls++ 
//#define kmp_rt_prio() rt_calls++
